...
echo_and_run cd "/home/sfan/mqp_ws/src/rosbridge_suite/rosbridge_server"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/sfan/mqp_ws/src/rosbridge_suite/rosbridge_server/setup.py" \
     \
    build --build-base "/home/sfan/mqp_ws/build/rosbridge_suite/rosbridge_server" \
    install \
    --root="${DESTDIR-/}" \
